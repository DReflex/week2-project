$(document).ready(function(){
  ...
  var posts = [object0, object1, object2,object3, object4, object5]
   ...
   function toggle(){
     ...
     $("#title").text(posts[randomPost].title)
     $("#image").attr('src', posts[randomPost].img)
     $("#date").text(posts[randomPost].date)
     $("#text").text(posts[randomPost].text)
     $("#link").attr('href', posts[randomPost].link)
   }
